...
基于 common 通用框架的西甲兼容层，提供西甲专属配置和别名。
所有核心逻辑位于 modules.common。

向后兼容性：
    from modules.laliga_odds import load_laliga_matches  # ✅ 可用
    from modules.laliga_odds import TEAM_MAPPINGS         # ✅ 可用
"""
...
TEAM_MAPPINGS = LALIGA_TEAM_MAPPINGS
...
__all__ = [
    ...
    'ODDS_DB_PATH', 'MatchData', 'OddsTemporalData', 'get_db_connection',
    'load_laliga_matches', 'load_league_matches', 'load_wdl_history',
