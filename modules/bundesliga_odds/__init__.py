...
基于 common 通用框架的德甲兼容层，提供德甲专属配置和别名。
所有核心逻辑位于 modules.common。

向后兼容性：
    from modules.bundesliga_odds import load_bundesliga_matches  # ✅ 可用
    from modules.bundesliga_odds import TEAM_MAPPINGS           # ✅ 可用
"""
...
__all__ = [
    ...
    'ODDS_DB_PATH', 'MatchData', 'OddsTemporalData', 'get_db_connection',
    'load_bundesliga_matches', 'load_league_matches', 'load_wdl_history',
