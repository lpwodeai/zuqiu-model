...
基于 common 通用框架的意甲兼容层，保持向后兼容。
所有核心逻辑已迁移到 modules.common，此模块仅提供 Serie A 特定的配置和别名。

向后兼容性：
    from modules.seriea_odds import load_seriea_matches  # ✅ 仍可用
    from modules.seriea_odds import TEAM_MAPPINGS        # ✅ 仍可用
"""
...
__all__ = [
    ...
    'ODDS_DB_PATH', 'MatchData', 'OddsTemporalData', 'get_db_connection',
    'load_seriea_matches', 'load_league_matches', 'load_wdl_history',
